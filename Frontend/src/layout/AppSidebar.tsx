...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Utilisateurs",
    subItems: [
      { name: "Gérer des utilisateurs", path: "/users", pro: false },
...
const othersItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Analyse",
    subItems: [
      { name: "Dérives par région", path: "/analytics/region", pro: false },
      { name: "Filtrage avancé", path: "/analytics/filters", pro: false },
    ],
  },
  {
    icon: <PageIcon />,
    name: "AI Model",
    subItems: [{ name: "Intégration modèle IA", path: "/ai-integration", pro: false }],
  },
];
          ...
          <div className="flex flex-col gap-4">
            <div>
              <h2 className={`mb-4 text-xs uppercase flex leading-[20px] text-gray-400 ${
                ...
                {isExpanded || isHovered || isMobileOpen ? "Administration" : <HorizontaLDots className="size-6" />}
              </h2>
            ...
            <div>
              <h2 className={`mb-4 text-xs uppercase flex leading-[20px] text-gray-400 ${
                ...
                {isExpanded || isHovered || isMobileOpen ? "Fonctionnalités" : <HorizontaLDots />}
              </h2>
